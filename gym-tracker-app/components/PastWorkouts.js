...
function PastWorkouts() {
    ...
    const workout =
        state.pastWorkouts && state.pastWorkouts.length >= index
            ? state.pastWorkouts[index]
            : null;
    ...
    const isNewDisabled =
        state.pastWorkouts.length == 0 || state.setCurrentWorkout;
    const isNextDisabled = index <= 0;
    const isPreviousDisabled =
        index == state.pastWorkouts.length - 1 ||
        state.pastWorkouts.length == 0;
            ...
            >
                ...
                <View style={styles.buttonContainer}>
                    ...
                    <TouchableOpacity
                        style={[
                            styles.smallButton,
                            isNewDisabled && { opacity: 0.5 },
                        ]}
                        disabled={isNewDisabled}
                        onPress={() => handleCopyNew()}
                    >
