    ...
    return (
        ...
        >
            ...
            <Text style={[styles.normalText, { marginBottom: 10 }]}>
                It looks like no existing data was found in your device. Please
                enter your username and password.
            </Text>
            <Text style={[styles.normalText, { marginBottom: 10 }]}>
                New user? Enter the account name and password you would like to
                use.
            </Text>
            <Text style={[styles.normalText, { marginBottom: 10 }]}>
                Minimum lenght for account name is 6 and password 8 characters.
                Lost account name or password can't be recovered when changing
                to a new device.
            </Text>
            <Text
                style={[
            ...
            >
                Important: never include any personal or sensitive data in your
                account name or data you feed into the system!
            </Text>
